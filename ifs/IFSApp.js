...
class IFSApp extends CindyApp {
  ...
  static get defaultConfig() {
    return {
      appName: 'Fraktale',
      appDescription: 'Fraktale sind mathematische Objekte, die Selbstähnlichkeiten aufweisen. Man kann das ursprüngliche Fraktal an verschiedenen Stellen innerhalb des Fraktales wieder finden. Hier kannst du mit diesen Selbstähnlichkeiten experimentieren.',
